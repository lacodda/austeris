// Utility functions for Austeris services
...
pub mod datetime {
    ...
    // Formats a PrimitiveDateTime to an ISO 8601 string (e.g., "2025-03-13T12:00:00.000000000Z")
    ...
    pub fn parse_iso8601(s: &str) -> Result<PrimitiveDateTime> {
        PrimitiveDateTime::parse(s, &Iso8601::DATE_TIME_OFFSET)
