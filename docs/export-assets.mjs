// One-off: rasterize austeris brand SVGs into PNGs + a multi-size .ico.
...
const ASSETS = "C:/Projects/austeris/assets";
...
// every size, which is how a 256px icon ended up a flat orchid blob.
